...
## Хайзиг – самый быстрый метод? 

## Метод Хайзига Remembering the Kanji (RTK) в двух словах

* учить кандзи надо в порядке их графического написания, а не в порядке употребляемости.
* запоминать чтения иероглифов в изоляции нет смысла - слишком много хаоса.
* для каждого иероглифа для начала нужно запомнить лишь **одно** из его частых значений. Остальные значения запомнить будет в десятки раз проще, когда в твоей памяти уже будет выделена коробочка для этого иероглифа.
